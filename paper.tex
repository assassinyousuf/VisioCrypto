...
\lstdefinestyle{mystyle}{
    backgroundcolor=\backgroundcolor{backcolour},   
...
\bibitem{carlini2021}
Carlini, N., et al.: Extracting training data from large language models. In: 30th USENIX Security Symposium (USENIX Security 21), pp. 2633--2650 (2021)

\bibitem{mironov2002}
Mironov, I.: (not so) random shuffles of rc4. In: Advances in Cryptology---CRYPTO 2002, pp. 304--323. Springer (2002)
...
Baptista, M.S.: Cryptography with chaos. Physics letters A, 240(1-2), 50--54 (1998)

\bibitem{kocarev2001}
Kocarev, L.: Chaos-based cryptography: a brief overview. IEEE Circuits and Systems Magazine, 1(3), 6--21 (2001)
...
\bibitem{kocher1996}
Kocher, P.C.: Timing attacks on implementations of Diffie-Hellman, RSA, DSS, and other systems. In: Advances in Cryptology---CRYPTO'96, pp. 104--113. Springer (1996)

\bibitem{grover1996}
Grover, L.K.: A fast quantum mechanical algorithm for database search. In: STOC, pp. 212--219 (1996)

\bibitem{settle2010}
Settle, J.: Linearization of nonlinear generators via cellular automata. arXiv:1005.0086 (2010)

\bibitem{mariot2024}
Mariot, L.: On the cryptographic security of cellular automata-based PRNGs. arXiv:2405.02875 (2024)

\bibitem{hossain2026visiolock}
Hossain, M.Y., Sajeeb, S.S.H., Ausaf, S.M.N., Rahman, M.M., Saharaz, N.H., Based, M.A.: VisioLock: Cross-media secure image transmission via audio-domain encoding and device-bound cryptography. Taylor \& Francis Book Chapter (2026)
\end{thebibliography}
